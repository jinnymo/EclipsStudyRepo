...
public class BookProgram {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------");
		//bookBox2클래스 인스턴스에 접근해서 속성값을 대입하고
		//콘솔창에 출력
		
		bookBox2.title = "플러터 ui 실전2";
		bookBox2.author = "김근호2";
		bookBox2.publishYear = 2022;
		bookBox2.totalPage = 230;
